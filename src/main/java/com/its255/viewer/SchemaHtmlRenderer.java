...
public class SchemaHtmlRenderer {
    ...
    /**
     * Simple vertical renderer that delegates to the existing `render(...)` implementation.
     */
...
//         Map<String, String> recordOverlay =
//                 editOverlay != null ? editOverlay.get(recordNo) : null;
...
// }
    ...
    private String row(String name, String value, int recordNo, FieldSpec fieldSpec) {
        ...
        sb.append("<td>");
        if (editable) {
            sb.append("<input type='text' class='form-control form-control-sm editable-field' ")
            ...
            if (fieldSpec != null) {
                sb.append("maxlength='").append(fieldSpec.lengthBytes).append("' ")
                    ...
                    .append(fieldSpec.type == FieldType.NUMERIC_TEXT ? "inputmode='decimal' " : "");
            }
            sb.append("/>");
    ...
    public String render(int recordNumber1Based) {
        ...
        sb.append(
                ...
                "<table id='verticalFieldsTable' data-total-fields='" + totalFields + "' " +
                "aria-labelledby='record-context' " +
